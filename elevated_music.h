...
#define ELEVATED_MUSIC_FILTER_CUTOFF_SCALE ((2.0f * 3.14159265358979323846f) / (float)ELEVATED_MUSIC_SAMPLE_RATE)
#define ELEVATED_MUSIC_NOTE_FREQ_START (8.175798916f / (float)ELEVATED_MUSIC_SAMPLE_RATE)
